...
const DeleteForm: React.FC<DeleteFormProps> = ({ product, onDelete }) => {
  ...
  return (
    <div>
        ...
        <Button onClick={deleteProduct} style={{ backgroundColor: 'rgb(214, 129, 1)' , marginLeft:'90px', marginTop: '20px', marginBottom: '20px', marginRight:'5px' }} variant="contained" color="primary">
            Yes
        </Button>
