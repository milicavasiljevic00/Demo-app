...
const MyCart = () => {
    ...
    useEffect(() => {
        const sum = orderProducts.reduce((sum, current) => sum + current.product.price, 0);
        setTotal(sum);
    }, [orderProducts])
                        ...
                        <Grid item xs={12} sm={12} lg={12} md={12}>
                            <div className='wrapper-content'>
                                ...
                                <div className="total-price">
                                    <label>Total:</label>
                                    <p>{total} {CurrencyEnum.RSD}</p>
                                    <Button onClick={handleOrder} style={{ backgroundColor: 'rgb(214, 129, 1)', width: '100px' }} variant="contained">Order</Button>
                                </div>
                            </div>
                        </Grid>
                    </Grid>
